...
void keyboard(unsigned char key, int xIn, int yIn)
{
	...
	case 27: // 27 is the esc key
		quit();
		cout<<"You succsefully closed Paint App !.\n";
		break;
	case 'c':
		clear();
		break;
...
void printGuide(){
	cout << "#                    Welcome to Shapes_Editor!!!                    #\n"
			  ...
			  << "\tPolygon of n sides\t\t"
			  << "-> draws a general Regular Polygon of n sides with length equal to distance between position of 2 mouse clicks.\n"
			  << "\tAirbrush\t"
